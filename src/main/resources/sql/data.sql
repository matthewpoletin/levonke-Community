...
INSERT INTO community.teams(teams_name, teams_orgnaization_id)
...
INSERT INTO community.users_teams(users_users_id, teams_teams_id)
    VALUES ((SELECT (users_id) FROM community.users WHERE users_username = 'MatthewPoletin'),
            (SELECT (teams_id) FROM community.teams WHERE teams_orgnaization_id = 1 AND teams_name = 'back-end developers')
    );