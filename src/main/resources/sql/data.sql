INSERT INTO community.users(users_username, users_avatar, users_bio, users_forename, users_surname, users_regemail, users_pubemail, users_ghlink, users_fbLink)
    VALUES ('MatthewPoletin', 'https://pp.userapi.com/c626922/v626922567/2429b/IjwJ0ZMRHNo.jpg', 'electronics and software engineer Moscow, Russia 22 y.o.', 'Matthew', 'Poletin', 'poletinm@yandex.ru', 'contact@matthewpoletin.ru', 'github.com/matthewpoletin', 'fb.me/matthewpoletin');
INSERT INTO community.users(users_username, users_avatar, users_bio, users_forename, users_surname, users_regemail, users_pubemail, users_ghlink, users_fbLink)
    VALUES ('kormvina', 'https://vignette.wikia.nocookie.net/firefly/images/4/44/Kaylee_closeup.jpg/revision/latest/scale-to-width-down/200?cb=20100426173253', 'Exceptional engineer with a natural intuition for machines, "Heart of Serenity"', 'Ksenia', 'Strogina', 'ksyshkazaglushka@mail.ru', 'stroginakp@student.bmstu.ru', 'github.com/kormvina', 'fb.me/kseniastrogina');
INSERT INTO community.users(users_username, users_avatar, users_bio, users_forename, users_surname, users_regemail, users_pubemail, users_ghlink, users_fbLink)
	VALUES ('molros', 'https://i.imgur.com/cKasgwf.jpg', 'Main protagonist in the universe and host of the YouTube channel.', 'Ogneslav', 'Pestritski', 'persicor@gmail.com', 'persicor@gmail.com', 'github.com/persicor', 'fb.me/persicor');
INSERT INTO community.users(users_username, users_avatar, users_bio, users_forename, users_surname, users_regemail, users_pubemail, users_ghlink, users_fbLink)
	VALUES ('sworen', 'http://d38we5ntdyxyje.cloudfront.net/73444/profile/avatar_medium_square.jpg', '', 'Isaac', 'Grey', 'persicor@gmail.com', 'persicor@gmail.com', 'github.com/isaac_grey', 'fb.me/isaacg');
...
INSERT INTO community.teams(teams_name, teams_organization_id)
    VALUES ('Wearables', (SELECT organizations_id FROM community.organizations WHERE organizations_name = 'Haywire'));
INSERT INTO community.teams(teams_name, teams_organization_id)
	VALUES ('Home consoles', (SELECT organizations_id FROM community.organizations WHERE organizations_name = 'Dreamedia'));
